    ...
    <form class="form-horizontal">
      <div class="option-basic clearfix">
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-xs-11">
            <input type="text" class="form-control fl" v-if="taskType=='0' || taskType=='2' || taskType=='4'" v-model="taskTarget">
            <textarea class="form-control fl" rows="5" v-if="taskType=='1' || taskType=='3' || taskType=='5'" placeholder="每行一条" v-model="taskTarget"></textarea>
      ...
      <div class="option-expert clearfix" v-if="scanMode=='1'">
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-xs-11">
            <select class="form-control fl" v-model="startTime.status">
              <option value="0" selected>立即启动</option>
              <option value="1">定时启动</option>
            </select>
            <input type="text" class="form-control fl" placeholder="2016-03-14 05:45:37" v-if="startTime.status=='1'" v-model="startTime.time">
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-xs-11">
            <label class="checkbox-inline"><input type="checkbox" v-model="checkAll">全选</label>
            <label class="checkbox-inline" v-for="checkBox in checkBoxes"><input type="checkbox" v-model="checkBox.checked">{{checkBox.label}}</label>
          </div>
        </div>
        <div class="form-group form-group-sm">
          <label class="col-xs-1 control-label">自定义请求头</label>
          <div class="col-xs-11 zdy_wrap">
            <dl class="fl">
